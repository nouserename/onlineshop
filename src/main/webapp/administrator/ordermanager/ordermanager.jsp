...
<![endif]-->
        ...
        <script type="text/javascript">
        	function printorders()
        	{
        		...
        		xmlhttp.open("GET","/onlineshop/administrator/ordermanager/OrderManager",true);
        		xmlhttp.send();
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li>
                        <!-- <a href="#">财务信息 <i class="im-gift"></i></a> -->
                        <!-- <a href="addnewperson.jsp">新增管理员 </a> -->
                         <a href="#" onclick="printorders()">打印 <i class="im-gift"></i></a>
            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="im-screen"></i><b>订单管理员</b></h1>
                        <!-- Start .bredcrumb -->
