...
&emsp;用户名&emsp;&emsp;<input type="text" name="username" Size=30 /><br />
...
&emsp;&emsp;&emsp;&emsp;&emsp;<input type="button" id="btn1" title="确认" value="确认" />&emsp;&emsp;&emsp;&emsp;&emsp;<input type="button" id="btn2" title="清空" value="清空" /></center><br />
</form>
